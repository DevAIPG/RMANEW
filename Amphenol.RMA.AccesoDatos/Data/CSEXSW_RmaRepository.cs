    ...
    IDENT_INCR('CSEXSW_Rma') as Incremento";
     ...
     Color.Red);
        ...
        public string Updateaprobar(int idsa, string commentt, string var, string mail1, string mail2, string mail3, string mail4, string mail5, string mail6, string mailp)
        {
            ...
            var approver = new
            {
                id = objDesdeDbs.res_id_approver,
                name = objDesdeDbs.Approver
            };

#if DEBUG
            var = approver.id.ToString() != var ? approver.id.ToString() : var;
#endif
            ...
            objDesdeDbs.Comment = string.IsNullOrEmpty(objDesdeDbs.Comment) ? $"{approver.name}: {commentt}"
                : $"{objDesdeDbs.Comment}{Environment.NewLine}{approver.name}: {commentt}";
